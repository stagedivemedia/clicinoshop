...
<div class="account-history-order common-summary col-sm-12">
	...
	<h4 class="header"><?= $enc->html( $this->translate( 'client', 'Order details' ), $enc::TRUST ); ?></h4>

	<div class="common-summary-address row">
		<div class="item payment col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'Billing address' ), $enc::TRUST ); ?></h5>
			</div>
		...
		--><div class="item delivery col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'Delivery address' ), $enc::TRUST ); ?></h5>
			</div>
	...
	<div class="common-summary-service row">
		<div class="item delivery col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'delivery' ), $enc::TRUST ); ?></h5>
			</div>
		...
		--><div class="item payment col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'payment' ), $enc::TRUST ); ?></h5>
			</div>
	...
	<div class="common-summary-additional row">
		<div class="item coupon col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'Coupon codes' ), $enc::TRUST ); ?></h5>
			</div>
		...
		--><div class="item comment col-sm-6">
			<div class="header">
				<h5><?= $enc->html( $this->translate( 'client', 'Your comment' ), $enc::TRUST ); ?></h5>
			</div>
	...
	<div class="common-summary-detail row">
		<div class="header col-sm-12">
			<h4><?= $enc->html( $this->translate( 'client', 'Details' ), $enc::TRUST ); ?></h4>
		</div>
