...
<div class="account-profile-address">
	<h3 class="header"><?= $enc->html( $this->translate( 'client', 'address' ) ) ?></h3>
	...
	<form method="POST" action="<?= $enc->attr( $this->link( 'client/html/account/profile/url' ) ); ?>">
		...
		<div class="row">
			<div class="billing col-lg-6">
				<h4 class="header"><?= $enc->html( $this->translate( 'client', 'Billing address' ) ) ?></h4>
				...
				<div class="panel panel-default address-billing">
					...
					<div class="panel-body collapse" id="address-payment">
						...
						<div class="form-list">
							...
							<!-- <div class="form-item form-group custom-field salutation">

								<label class="custom-label" for="address-payment-salutation">
								...
								<div class="custom-input">
									<select class="form-control" id="address-payment-salutation"
										...
										<?php endforeach; ?>
                                          ...
                                          <div class="row">
                                                <div class="form-item col-md-6 form-group custom-field firstname">

                                                      <label class="custom-label" for="address-payment-firstname">
                                                ...
                                                <div class="form-item col-md-6 form-group custom-field lastname">

                                                      <label class="custom-label" for="address-payment-lastname">
							...
							<div class="form-item form-group custom-field company">

								<label class="custom-label" for="address-payment-company">
								...
								<div class="custom-input">
									...
									/>
                                          ...
                                          <div class="row">
                                                <div class="form-item col-md-5 form-group custom-field address1">

                                                      <label class="custom-label" for="address-payment-address1">
                                                ...
                                                <div class="form-item col-md-2 form-group custom-field postal">

                                                      <label class="custom-label" for="address-payment-postal">
                                                ...
                                                <div class="form-item col-md-5 form-group custom-field city">

                                                      <label class="custom-label" for="address-payment-city">
							...
							<div class="form-item form-group custom-field address2">

								<label class="custom-label" for="address-payment-address2">
							...
							<!-- <div class="form-item form-group custom-field address3">

								<label class="custom-label" for="address-payment-address3">
							...
							<!-- <?php if( !empty( $this->get( 'addressStates', [] ) ) ) : ?>
								<div class="form-item form-group custom-field state">

									<label class="custom-label" for="address-payment-state">
							...
							<?php if( !empty( $this->get( 'addressCountries', [] ) ) ) : ?>
								<div class="form-item form-group custom-field countryid">

									<label class="custom-label" for="address-payment-countryid">
							...
							<!-- <div class="form-item form-group custom-field languageid">

								<label class="custom-label" for="address-payment-languageid">
							...
							<!-- <div class="form-item form-group custom-field vatid">

								<label class="custom-label" for="address-payment-vatid">
							...
							<div class="form-item form-group custom-field email"
								data-regex="^.+@[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]+)*$">

								<label class="custom-label" for="address-payment-email">
							...
							<!-- <div class="form-item form-group custom-field telephone">

								<label class="custom-label" for="address-payment-telephone">
								...
								<div class="custom-input">
									...
									/>
                                          ...
                                          <!-- 
							<div class="form-item form-group custom-field telefax">

								<label class="custom-label" for="address-payment-telefax">
							...
							<!-- <div class="form-item form-group custom-field website"
								data-regex="^([a-z]+://)?[a-zA-Z0-9\-]+(\.[a-zA-Z0-9\-]+)+(:[0-9]+)?(/.*)?$">

								<label class="custom-label" for="address-payment-website">
							...
							<div class="form-item form-group custom-field birthday">
								<label class="custom-label" for="address-payment-birthday">
			...
			<div class="delivery col-lg-6">
				<h4 class="header"><?= $enc->html( $this->translate( 'client', 'Delivery address' ) ) ?></h4>
						...
						<div class="panel-body collapse" id="address-delivery-<?= $enc->attr( $pos ) ?>">
							...
							<div class="form-list">
								...
								<!-- <div class="form-item form-group custom-field salutation">
									...
									<label class="custom-label" for="address-delivery-salutation-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Salutation' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
								...
								<div class="form-item form-group custom-field firstname">

									<label class="custom-label" for="address-delivery-firstname-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'First name' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field lastname">

									<label class="custom-label" for="address-delivery-lastname-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Last name' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field company">
									...
									<label class="custom-label" for="address-delivery-company-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Company' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field address1">

									<label class="custom-label" for="address-delivery-address1-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Street' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field address2">
									...
									<label class="custom-label" for="address-delivery-address2-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Additional' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<!-- <div class="form-item form-group custom-field address3">
									...
									<label class="custom-label" for="address-delivery-address3-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Additional 2' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field city">

									<label class="custom-label" for="address-delivery-city-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'City' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<!-- <?php if( !empty( $this->get( 'addressStates', [] ) ) ) : ?>
									<div class="form-item form-group custom-field state">
										...
										<label class="custom-label" for="address-delivery-state-<?= $pos ?>">
											<?= $enc->html( $this->translate( 'client', 'State' ), $enc::TRUST ); ?>
										</label>
										<div class="custom-input">
								...
								<div class="form-item form-group custom-field postal">

									<label class="custom-label" for="address-delivery-postal-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Postal code' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<?php if( !empty( $this->get( 'addressCountries', [] ) ) ) : ?>
									<div class="form-item form-group custom-field countryid">
										...
										<label class="custom-label" for="address-delivery-countryid-<?= $pos ?>">
											<?= $enc->html( $this->translate( 'client', 'Country' ), $enc::TRUST ); ?>
										</label>
										<div class="custom-input">
								...
								<div class="form-item form-group custom-field languageid">
									...
									<label class="custom-label" for="address-delivery-languageid-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Language' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
								...
								<!-- <div class="form-item form-group custom-field vatid">
									...
									<label class="custom-label" for="address-delivery-vatid-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Vat ID' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="text"
								...
								<div class="form-item form-group custom-field email"
									...
									<label class="custom-label" for="address-delivery-email-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'E-Mail' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="email"
								...
								<!-- <div class="form-item form-group custom-field telephone">
									...
									<label class="custom-label" for="address-delivery-telephone-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Telephone' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="tel"
								...
								<!-- <div class="form-item form-group custom-field telefax">
									...
									<label class="custom-label" for="address-delivery-telefax-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Fax' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="tel"
								...
								<!-- <div class="form-item form-group custom-field website"
									...
									<label class="custom-label" for="address-delivery-website-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Web site' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control" type="url"
								...
								<div class="form-item form-group custom-field birthday">
									<label class="custom-label" for="address-delivery-birthday-<?= $pos ?>">
										<?= $enc->html( $this->translate( 'client', 'Birthday' ), $enc::TRUST ); ?>
									</label>
									<div class="custom-input">
										<input class="form-control birthday" type="date"
