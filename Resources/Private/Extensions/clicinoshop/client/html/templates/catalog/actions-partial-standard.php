...
<div class="catalog-actions">
      <a class="actions-button-favorite-loggedin" href="/login"><span class="heart-label">Auf meine Merkliste</span></a>
	<?php foreach( $this->config( 'client/html/catalog/actions/list', ['pin', 'watch', 'favorite'] ) as $entry ) : ?>
		<?php if( isset( $urls[$entry] ) ) : ?>
			<a class="actions-button-custom actions-button-<?= $enc->attr( $entry ); ?>" href="<?= $enc->attr( $urls[$entry] ); ?>" title="<?= $enc->attr( $this->translate( 'client/code', $entry ) ); ?>"><span class="heart-label">Auf meine Merkliste</span></a>
