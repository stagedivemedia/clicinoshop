	...
	<p class="note"><?= $enc->html( $this->translate( 'client', 'Please choose your payment method' ), $enc::TRUST ); ?></p>
      <div class="custom-payment">
            <?php foreach( $this->get( 'paymentServices', [] ) as $id => $service ) : ?>
                  <div id="c_payment-<?= $enc->attr( $id ); ?>" class="item custom-payment-item item-service row">
                        
                        <div class="custom-payment-top col-sm-12">
                        ...
                        <div class="custom-payment-sub col-sm-12">
