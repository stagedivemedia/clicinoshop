...
<div class="personal">
      ...
      <div class="row">
            <div class="custom-field col-md-6 form-item form-group salutation <?= $enc->attr( ( $this->value( 'error', 'order.base.address.salutation' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.salutation', [] ) ) ) ?>">
                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-salutation-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group firstname <?= $enc->attr( ( $this->value( 'error', 'order.base.address.firstname' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.firstname', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.firstname' ) ) ?>" >

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-firstname-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group lastname <?= $enc->attr( ( $this->value( 'error', 'order.base.address.lastname' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.lastname', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.lastname' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-lastname-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group email <?= $enc->attr( ( $this->value( 'error', 'order.base.address.email' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.email', [] ) ) ) ?>"
                  ...
                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-email-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group company <?= $enc->attr( ( $this->value( 'error', 'order.base.address.company' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.company', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.company' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-company-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group telephone <?= $enc->attr( ( $this->value( 'error', 'order.base.address.telephone' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.telephone', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.telephone' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-telephone-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group telefax <?= $enc->attr( ( $this->value( 'error', 'order.base.address.telefax' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.telefax', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.telefax' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-telefax-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group website <?= $enc->attr( ( $this->value( 'error', 'order.base.address.website' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.website', [] ) ) ) ?>"
                  ...
                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-website-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group birthday <?= $enc->attr( ( $this->value( 'error', 'order.base.address.birthday' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.birthday', [] ) ) ) ?>">
                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-birthday-<?= $this->get( 'id' ) ?>">
...
<div class="adresso">
      <h4>Deine Adresse:</h4>
      <div class="row">
            <div class="custom-field col-md-5 form-item form-group address1 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address1' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address1', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.address1' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-address1-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-2 form-item form-group postal <?= $enc->attr( ( $this->value( 'error', 'order.base.address.postal' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.postal', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.postal' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-postal-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-5 form-item form-group city <?= $enc->attr( ( $this->value( 'error', 'order.base.address.city' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.city', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.city' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-city-<?= $this->get( 'id' ) ?>">
            ...
            <?php if( count( $this->get( 'states', [] ) ) > 0 ) : ?>
                  <div class="custom-field col-md-6 form-item form-group state <?= $enc->attr( ( $this->value( 'error', 'order.base.address.state' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.state', [] ) ) ) ?>">

                        <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-state-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field col-md-6 form-item form-group address2 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address2' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address2', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.address2' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-address2-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field form-item col-md-6 form-group address3 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address3' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address3', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.address3' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-address3-<?= $this->get( 'id' ) ?>">
            ...
            <?php if( count( $this->get( 'countries', [] ) ) > 0 ) : ?>
                  <div class="custom-field col-md-6 form-item form-group countryid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.countryid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.countryid', [] ) ) ) ?>">

                        <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-countryid-<?= $this->get( 'id' ) ?>">
            ...
            <?php if( count( $this->get( 'languages', [] ) ) > 0 ) : ?>
                  <div class="custom-field col-md-6 form-item form-group languageid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.languageid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.languageid', [] ) ) ) ?>"
                        <?= $this->value( 'css', 'order.base.address.languageid' ) ? '' : 'disabled' ?> >

                        <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-languageid-<?= $this->get( 'id' ) ?>">
            ...
            <div class="custom-field form-item col-md-6 form-group vatid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.vatid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.vatid', [] ) ) ) ?>"
                  data-regex="<?= $enc->attr( $this->config( 'client/html/checkout/standard/address/validate/order.base.address.vatid' ) ); ?>">

                  <label class="custom-label" for="address-<?= $this->get( 'type', 'billing' ) ?>-vatid-<?= $this->get( 'id' ) ?>">
