...
$this->pdf->setHeaderFunction( function( $pdf ) {
	$pdf->writeHtmlCell( 210, 30, 0, 0, '
		<div style="background-color: #eaeaea; color: #ffffff; text-align: center; font-weight: bold">
			<div style="font-size: 0px"> </div>
			<img src="https://www.girard.at/fileadmin/user_upload/ClicinoShop/clicino_logo.png" height="30" />
			<div style="font-size: 0px"> </div>
		</div>
	' );
} );
...
$this->pdf->setFooterFunction( function( $pdf ) {
	...
	' );
	$pdf->writeHtmlCell( 210, 30, 0, -5, '
		<div style="background-color: #cc0033; color: #ffffff; text-align: center; font-weight: bold; font-size: 10px;">
			girard.at // clicino.at
		</div>
	' );
} );
