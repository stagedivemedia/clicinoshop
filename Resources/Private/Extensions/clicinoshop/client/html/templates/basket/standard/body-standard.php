...
<section class="aimeos basket-standard" data-jsonurl="<?= $enc->attr( $this->url( $optTarget, $optCntl, $optAction, [], [], $optConfig ) ); ?>">
	...
	<?php if( isset( $this->standardBasket ) ) : ?>
		<h3><?= $enc->html( $this->translate( 'client', 'Basket' ), $enc::TRUST ); ?></h3>
			...
			<div class="common-summary-detail">
				...
				<div class="basket">
                  ...
                  <div class="row low-row"> 
                        ...
                        <div class="basket-standard-coupon col col-lg-4">
                                    <p class="coupon-label"><?= $enc->html( $this->translate( 'client', 'Coupon codes' ) ); ?></p>
                              ...
                              <div class="content">
                                    ...
                                    <div class="input-group coupon-new">
                                          ...
                                          --><button class="btn btn-check-coupon" type="submit"><?= $enc->html( $this->translate( 'client', 'check' ) ); ?></button>
                                    </div>
